...
public class BodyMediaTest {
    ...
    public void repeatCheck() {
        for (Body body : b) {
            System.out.println("* " + body.getClass().getSimpleName() + "Test: test method 1 - repeatCheck()");
            body.setRepeat(5);
            body.setRepeat(0);
    ...
    public void beginCheck() {
        for (Body body : b) {
            System.out.println("* " + body.getClass().getSimpleName() + "Test: test method 2 - beginCheck()");
            body.setBegin(2.0);
            body.setBegin(-1.0);
    ...
    public void endCheck() {
        ...
        for (Body body : b) {
            System.out.println("* " + body.getClass().getSimpleName() + "Test: test method 3 - endCheck()");
            body.setEnd(2.0);
            body.setEnd(-1.0);
    ...
    @Test
    public void srcCheck() {
        for (Media media : m) {
            System.out.println("* " + media.getClass().getSimpleName() + "Test: test method 5 - srcCheck()");
    ...
    public void toXmlCheck() {
        ...
        assertEquals("<seq id=\"s2\" repeat=\"5\" begin=\"2.0\" end=\"2.0\">\n</seq>\n", s2.toXml());
        assertEquals("<seq id=\"s3\" repeat=\"1\" begin=\"0.0\">\n</seq>\n", s3.toXml());
        assertEquals("<seq id=\"s4\" repeat=\"1\" begin=\"4.9E-324\" end=\"1.7976931348623157E308\">\n</seq>\n", s4.toXml());

        System.out.println("* ParallelTest: test method 10 - toXmlCheck()");
        assertEquals("<par id=\"p2\" repeat=\"5\" begin=\"2.0\" end=\"2.0\">\n</par>\n", p2.toXml());
        assertEquals("<par id=\"p3\" repeat=\"1\" begin=\"0.0\">\n</par>\n", p3.toXml());
        assertEquals("<par id=\"p4\" repeat=\"1\" begin=\"1.7976931348623157E308\" end=\"4.9E-324\">\n</par>\n", p4.toXml());

        System.out.println("* TextTest: test method 10 - toXmlCheck()");
        assertEquals("<text id=\"t2\" repeat=\"5\" begin=\"2.0\" end=\"2.0\" src=\"source.extension\" region=\"r10\" fill=\"remove\"/>\n", t2.toXml());
        assertEquals("<text id=\"t3\" repeat=\"1\" begin=\"0.0\" end=\"0.0\" src=\"null\" region=\"r3\" fill=\"remove\"/>\n", t3.toXml());

        System.out.println("* ImageTest: test method 10 - toXmlCheck()");
        assertEquals("<img id=\"i2\" repeat=\"5\" begin=\"2.0\" end=\"2.0\" src=\"source.extension\" region=\"r10\" fill=\"remove\"/>\n", i2.toXml());
        assertEquals("<img id=\"i3\" repeat=\"1\" begin=\"0.0\" end=\"0.0\" src=\"null\" region=\"r6\" fill=\"remove\"/>\n", i3.toXml());

        System.out.println("* AudioTest: test method 10 - toXmlCheck()");
        assertEquals("<audio id=\"a2\" repeat=\"5\" begin=\"2.0\" end=\"2.0\" src=\"source.extension\" clip-begin=\"2.0\" clip-end=\"2.0\"/>\n", a2.toXml());
        assertEquals("<audio id=\"a3\" repeat=\"1\" begin=\"0.0\" end=\"0.0\" src=\"null\" clip-begin=\"0.0\" clip-end=\"0.0\"/>\n", a3.toXml());

        System.out.println("* VideoTest: test method 10 - toXmlCheck()");
        assertEquals("<video id=\"v2\" repeat=\"5\" begin=\"2.0\" end=\"2.0\" src=\"source.extension\" region=\"r10\" fill=\"freeze\" clip-begin=\"2.0\" clip-end=\"2.0\"/>\n", v2.toXml());
        assertEquals("<video id=\"v3\" repeat=\"2147483647\" begin=\"1.7976931348623157E308\" end=\"1.7976931348623157E308\" src=\"null\" region=\"r9\" fill=\"remove\" clip-begin=\"1.7976931348623157E308\" clip-end=\"1.7976931348623157E308\"/>\n", v3.toXml());
    }
}
